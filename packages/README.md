...
| `application-witness` | `office_application_witness` | `office-witness` | Clone-only LibreOffice observation; no publication |

There is intentionally no shared `OfficeArtifactBase`, Office AST, OOXML runtime, or cross-format SceneSpec. The witness has no mutation or publication authority.
